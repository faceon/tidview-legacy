...
- Entrypoint is `portfolio.html` → `<tidview-portfolio>` defined in `portfolio.js`; `positions-section.js` renders a summarized, sortable list using Lit + Material Web components.
